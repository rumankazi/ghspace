...
[![fallow health](.github/badges/fallow-health.svg)](apps/docs/content/docs/code-health.mdx)
...
The badge above is a snapshot, regenerated by `bun run badge` — it is not live.
[Code health](apps/docs/content/docs/code-health.mdx) explains what the two
analysers check and what they deliberately do not, and the docs site serves an
interactive map of the module graph at `/fallow-map.html`.
