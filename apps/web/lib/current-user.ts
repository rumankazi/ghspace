 ...
 *
 * Cached per request because the nav in `(app)/layout.tsx` and the page beneath
 * it both need the user, and the two render in the same pass: without this,
 * every dashboard load would look the row up twice to render it once.
 */
